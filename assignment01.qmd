...
1.  Google "generative art". Cite some examples.
    ...
    <https://images.squarespace-cdn.com/content/v1/5c77350965a707ed1710a1bc/1591715843997-AKH1TSMXYIEMX19Q7XAD/Generative+Art+By+Katharina+Brunner.png?format=750w>
...
3.  Write a critique on a chart in published work (book/article/news website).
    ...
    Scales on Y-axis (no defined) distort the results.

    https://www.datapine.com/blog/misleading-statistics-and-data/

    ![](misleading-statistic-planned-parenthood.jpg)
